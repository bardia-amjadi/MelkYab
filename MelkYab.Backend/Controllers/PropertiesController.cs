...
public class PropertiesController : ControllerBase
{
    ...
    public async Task<ActionResult> GetProperties()
    {
        ...
        var result = properties.Select(p => new
        {
            ...
            links = new[]
            {
                new { rel = "self", href = Url.Action(nameof(GetProperty), new { id = p.Id }), method = "GET" },
                new { rel = "update", href = Url.Action(nameof(UpdateProperty), new { id = p.Id }), method = "PUT" },
                new { rel = "delete", href = Url.Action(nameof(DeleteProperty), new { id = p.Id }), method = "DELETE" }
            }
        });
        ...
        return Ok(new
        {
            ...
            links = new[]
            {
                new { rel = "self", href = Url.Action(nameof(GetProperties)), method = "GET" },
                new { rel = "create", href = Url.Action(nameof(CreateProperty)), method = "POST" }
            }
        });
    }
    ...
    public async Task<ActionResult> GetProperty(string id)
    {
        ...
        return Ok(new
        {
            ...
            links = new[]
            {
                new { rel = "self", href = Url.Action(nameof(GetProperty), new { id = property.Id }), method = "GET" },
                new { rel = "update", href = Url.Action(nameof(UpdateProperty), new { id = property.Id }), method = "PUT" },
                new { rel = "delete", href = Url.Action(nameof(DeleteProperty), new { id = property.Id }), method = "DELETE" },
                new { rel = "list", href = Url.Action(nameof(GetProperties)), method = "GET" }
            }
        });
    }
